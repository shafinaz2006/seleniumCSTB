...
public class CSTBExams {
  public static void main(String[] args) {
    ...
    action.moveToElement(driver.findElement(By.xpath("//li[contains(@id, 'menu-item')]//a[contains(text(), 'Exams')]")))
        .perform();
    driver.findElement(By.xpath("//ul[@class = 'sub-menu']//a[contains(text(), 'Exam Information')]")).click();
    String costInfo = 
      driver.findElement(By.xpath("//h3[contains(text(), 'Cost')]/following-sibling::p[1]")).getAttribute("innerText");
    ...
    List<WebElement> entranceCriteria = driver.findElements(
        By.xpath("//h2[contains(text(), 'Entrance Criteria')]//following-sibling::p//following-sibling::ul"));
    ...
    List<WebElement> bookInfoList = driver
        .findElements(By.xpath("//h3[contains(text(), 'Advanced Level Books')]//following-sibling::p"));

    String bookInfo, bookName, price, author;
