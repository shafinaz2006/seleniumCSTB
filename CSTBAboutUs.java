...
public class CSTBAboutUs {
  ...
  private static void TC_AboutUs_ContactUs(WebDriver driver, String name, String email, 
                                          String subject, String message, Actions action) {
    action
        .moveToElement(driver.findElement(By.xpath("//li[contains(@id, 'menu-item')]//a[contains(text(), 'About Us')]")))
        .perform();
