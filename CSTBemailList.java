...
public class CSTBemailList {
  public static void main(String[] args) throws IOException {
    ...
    List<WebElement> testerNameList = driver
        .findElements(By.xpath("//div[@class = 'post-listings']//li[contains(text(), testerName)]"));
    ...
    // Boolean testerNameDisplay =
    // driver.findElement(By.xpath("//li[contains(text(),
    // testerName1)]")).isDisplayed();
